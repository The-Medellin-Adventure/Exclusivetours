...
if (window.token) {
  ...
  function escapeHtml(str) {
    ...
    return String(str)
      ...
      .replace(/"/g, (atob('JnF1b3Q7')))
      .replace(/'/g, (atob('JiMzOTs=')));
  }
...
function showErrorMessage(titulo, mensaje) {
  ...
  overlay.innerHTML = `
    <div style="background:#fff;color:#000;padding:20px;border-radius:10px;max-width:400px;text-align:center;">
      ...
      <p style=(atob('bWFyZ2luLXRvcDoxMnB4O2ZvbnQtc2l6ZToxNHB4O2NvbG9yOiM0NDQ7'))>The Medellín Adventure</p>
    </div>
  `;
}
...
function mostrarCarrusel(imagenes, titulo) {
  ...
  imagenes.forEach(function (img) {
    ...
    slide.innerHTML = `
      <div style=(atob('ZGlzcGxheTpmbGV4O2ZsZXgtZGlyZWN0aW9uOmNvbHVtbjthbGlnbi1pdGVtczpjZW50ZXI7'))>
        <img src=(atob('L2FwaS9zaWduZWQtdXJsP3Rva2VuPSR7d2luZG93LnRva2VufSZmaWxlPSR7ZW5jb2RlVVJJQ29tcG9uZW50KGZpbGVQYXRoKX0='))
             style=(atob('bWF4LXdpZHRoOjgwJTttYXgtaGVpZ2h0OjYwdmg7b2JqZWN0LWZpdDpjb250YWluO2JvcmRlci1yYWRpdXM6OHB4Ow==')) />
